...
class AddProductRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'product_info.required'=>'Thông tin sản phẩm không được để trống',
            'product_describe.required'=>'Miêu tả sản phẩm không được để trống',
            'product_img.image'=>'File Ảnh không đúng định dạng',
            'attr.required'=>'thuộc tính không được để trống'
