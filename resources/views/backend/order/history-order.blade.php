                                    ...
                                    <div class="col-md-6">
                                        <div class="panel panel-blue">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <br>
                                                <strong><span class="glyphicon glyphicon-time" aria-hidden="true"></span> Thời được hoàn thành : {{ \Carbon\Carbon::parse($customer->updated_at)->format('H:i:s ; d/m/Y')}}</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
