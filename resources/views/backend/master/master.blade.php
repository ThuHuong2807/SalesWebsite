...
<head>
    ...
    <script type="text/javascript" src="public/backend/js/ckeditor/ckeditor.js"></script>
    <script type="text/javascript" src="public/backend/js/ckeditor/ckfinder/ckfinder.js"></script>
</head>
